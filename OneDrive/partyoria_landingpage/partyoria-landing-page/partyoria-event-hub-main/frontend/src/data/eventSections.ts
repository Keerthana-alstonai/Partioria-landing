...
export const festivalSubtypes: FestivalSubtype[] = [
  ...
  { id: 'pongal', name: 'Pongal', additionalVendors: [createVendor('Sugarcane Vendors', 'Catering'), createVendor('Traditional Pot Suppliers', 'Services'), createVendor('Kolam Artists', 'Decoration'), createVendor('Tamil Folk Dancers', 'Entertainment')] },
...
export const eventSections: EventSection[] = [
  {
    ...
    subsections: [
      ...
      },
      {
        ...
        vendors: [
          createVendor('Trainers/Instructors', 'Speaking'),
          createVendor('Interactive Tool Providers', 'Technical'),
          ...commonVendors.technical,
          ...commonVendors.catering,
          ...commonVendors.coordination,
        ],
      ...
      {
        id: 'business-networking-event',
        name: 'Business Networking Event',
        vendors: [
          createVendor('Icebreaker Facilitators', 'Entertainment'),
          ...commonVendors.catering,
          ...commonVendors.photography,
          ...commonVendors.coordination,
        ],
    ...
    subsections: [
      ...
      },
      {
        ...
        vendors: [
          ...
          createVendor('Caterers (Traditional Food)', 'Catering'),
          ...commonVendors.decoration,
          ...commonVendors.photography,
        ],
      },
      ...
      },
      {
        ...
        name: 'Art Exhibition',
        vendors: [
          createVendor('Artists/Curators', 'Services'),
          ...commonVendors.technical,
          ...commonVendors.catering,
          ...commonVendors.photography,
        ],
    ...
    subsections: [
      ...
      },
      {
        ...
        vendors: [
          ...
          ...commonVendors.coordination,
          createVendor('Caterers (Healthy Food)', 'Catering'),
          createVendor('Wellness Suppliers', 'Services'),
        ],
      },
      {
        id: 'yoga-festival',
        name: 'Yoga Festival',
        vendors: [
          createVendor('Yoga Instructors', 'Speaking'),
          createVendor('Mat Suppliers', 'Services'),
          ...commonVendors.catering,
          ...commonVendors.photography,
        ],
      },
  ...
  },
  {
    ...
    subsections: [
      ...
      },
      {
        ...
        name: 'Pongal',
        vendors: [
          createVendor('Sugarcane Vendors', 'Catering'),
          createVendor('Traditional Pot Suppliers', 'Services'),
          createVendor('Kolam Artists', 'Decoration'),
          createVendor('Tamil Folk Dancers', 'Entertainment'),
          ...commonVendors.catering,
          ...commonVendors.decoration,
          ...commonVendors.photography,
        ],
  ...
  },
  {
    ...
    subsections: [
      ...
      },
      {
        ...
        vendors: [
          createVendor('Tech Suppliers', 'Technical'),
          createVendor('Moderators', 'Speaking'),
          ...commonVendors.catering,
          ...commonVendors.photography,
        ],
      ...
      },
      {
        ...
        vendors: [
          createVendor('Timing Services', 'Services'),
          createVendor('Sponsors', 'Services'),
          createVendor('Medical Teams', 'Services'),
        ],
      },
      {
      ...
      },
      {
        ...
        vendors: [
          createVendor('Equipment Setup', 'Technical'),
          createVendor('Medical Teams', 'Services'),
          ...commonVendors.photography,
        ],
      },
      ...
      },
      {
        ...
        vendors: [
          createVendor('Tech/AV Teams', 'Technical'),
          createVendor('Moderators', 'Speaking'),
          ...commonVendors.catering,
        ],
      },
  ...
  },
  {
    ...
    subsections: [
      ...
      },
      {
        ...
        name: 'Career Expo',
        vendors: [
          createVendor('Recruiters', 'Services'),
          createVendor('Booth Designers', 'Technical'),
          ...commonVendors.catering,
        ],
      },
    ...
    subsections: [
      {
        ...
        vendors: [
          ...
          createVendor('Beach Venue', 'venue'),
          createVendor('Yoga Instructors', 'Speaking'),
          createVendor('Wellness Coaches', 'Speaking'),
          createVendor('Caterers (Healthy Food)', 'Catering'),
          ...commonVendors.photography,
        ],
      },
      ...
      },
      {
        ...
        vendors: [
          createVendor('Nutritionists', 'Speaking'),
          createVendor('Materials Suppliers', 'Services'),
          ...commonVendors.catering,
        ],
      },
